...
//        AIQuestionRequest request = objectMapper.readValue(requestJson, AIQuestionRequest.class);
    ...
    public ApiResponse<ListQuestionResponse> question(@PathVariable Long modelId) {
        return ApiResponse.success(assistantService.history(modelId));
    }
    ...
    public ApiResponse<Void> reset(@PathVariable Long modelId) {
        assistantService.delete(modelId);
